...
function Home() {
  ...
  const SearchResults = () => {
    ...
    const handleInfoClick = (index) => {
      const newShowInfo = showInfo.map((_, i) =>
        i === index ? !showInfo[index] : false
      );
            ...
            return (
              <div
                className={`${finalCard} ${styles.card} ${
                  showInfo[index] ? styles.cardSelected : ""
                }`}
                ...
                <div className={`ms-3 mt-3 card-body ${styles.cardContent}`}>
                  ...
                  {showInfo[index] && (
                    <div>
                      ...
                      <div className="my-3">
                        <p>Description:</p>
                        <p className={styles.resultInfo}>{result.info}</p>
                      </div>
                      <div>
                        {result.businessHours.map((businessHours, index) => {
                          const timeOpen =
                            businessHours.open != null
